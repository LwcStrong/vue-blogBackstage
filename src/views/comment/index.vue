...
<!-- 评论列表 -->
    <div class="app-container">
        ...
        >
            ...
            <el-table-column prop="description" label="昵称" width="100">
            ...
            <el-table-column prop="description" label="评论日期" width="230">
...
<script>
    import {delComment,getComment } from '@/api/comment.js'
    ...
    export default {
        ...
        methods: {
            ...
            deleteCommentHandle(commentInfo) {
                this.$confirm('你确定要删除该条评论?','提示', {
                    confirmButtonText: '确定',
                    cancelButtonText: '取消',
                    type: 'warning',
                    center: true
                    }).then(() => {
                        delComment(commentInfo.id).then(res => {
                            this.fetchData()
                            this.$message({
                                type: 'success',
                                message: '删除成功!'
